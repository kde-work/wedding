	...
	if ( is_user_logged_in() ) {
		...
		<div class="tp">
            ...
            <div class="tableplan">
                ...
                <div id="side_menu" style="/*position: fixed;*/ top: 109px; left: 0; width: 180px; margin-left: 2px; border-top-width: 1px; border-top-style: solid; border-top-color: rgb(215, 227, 234); border-left-width: 1px; border-left-style: solid; border-left-color: rgb(215, 227, 234); height: 386px; background-color: rgb(255, 255, 255);z-index:1000;">
                    <div style="position:absolute;left:0px;width:180px;top:0px;z-index: 1000;height:42px;background-color:#6FBFFF;border-bottom:1px solid #fff;">
                        <a href="#" id="save_icon" class="save_icon" title="Сохранение" onclick="ShowSubMenu('m10');return false;"></a>
                        <a href="#" class="print_icon" title="Печать" onclick="ShowSubMenu('m11'); return false;"></a>
                        <a href="#" class="stats_icon" title="Статистика" onclick="ShowSubMenu('m9');return false;"></a>
                        <a href="#" class="settings_icon" title="Настройки" onclick="ShowSubMenu('m8');return false;"></a>
                    </div>

                    <div id="tablesMenu" class="menu_button" style="top: 43px; border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: rgb(255, 255, 255); /*background-color: rgb(111, 191, 255);*/ height: 36px; padding-top: 4px; background-position: initial initial; background-repeat: initial initial;" onclick="ShowSubMenu('m0');">&nbsp;<img class="tables_icon" src="<?php echo plugins_url('/html/img/planner/blank.png', $wb_file); ?>">Tables »</div>
                    <div id="objectsMenu" class="menu_button" style="top: 84px; border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: rgb(255, 255, 255); /*background-color: rgb(111, 191, 255);*/ height: 36px; padding-top: 4px; background-position: initial initial; background-repeat: initial initial;" onclick="ShowSubMenu('m12');">&nbsp;<img class="objects_icon" src="<?php echo plugins_url('/html/img/planner/blank.png', $wb_file); ?>">Objects »</div>
                    ...
                    <div class="menu" style="height:17px;padding-top:1px;top:165px;background-color:#ffffff;color:#00657F;border-top:1px solid #D7E3EA">
                        <span style="font-size: 12px;">&nbsp;Guests without a place:</span>
                    </div>
                    <div id="unseatedGuestList" class="menu" style="height:200px;top:185px;left:0px;overflow:auto;border-bottom:1px solid #D7E3EA" title="Drag the guest with the mouse to the plan.">
                    </div>

                    <div class="menu" style="top:387px;height:24px;background-color:#FFFFFF;border-bottom:1px solid #D7E3EA;padding-top:5px;">&nbsp;Size: &nbsp;
                        <input id="planSizeX" onblur="Change_Plan_X()" onkeydown="if (event.keyCode == 13) { Change_Plan_X(); }" type="text" style="width:35px;font-size:10px" value="133.8">&nbsp;x&nbsp;
                        <input id="planSizeY" onblur="Change_Plan_Y()" onkeydown="if (event.keyCode == 13) { Change_Plan_Y(); }" type="text" style="width:35px;font-size:10px" value="62.6">
                    </div>
                ...
                <div id="plannerCanvas" class="plannerCanvas" style="position: absolute; left: 183px; top: 109px; border: 1px solid rgb(215, 227, 234); z-index: 100; width: 1338px; height: 626px; background-image: url('<? echo plugins_url('/html/img/planner/grid.gif', $wb_file); ?>');" oncontextmenu="return false;" onmousedown="PlannerCanvasMouseDown(); return false;" droppable=""><div style="position: relative; display: inline-block; width: 1338px; height: 626px;" class="kineticjs-content" role="presentation"><canvas style="padding: 0; 0.margin: 0; border: 0 none; background: transparent none repeat scroll 0% 0%; position: absolute; top: 0; left: 0; width: 1338px; height: 626px;" width="1338" height="626"></canvas></div></div>
                ...
                <script type="text/javascript" src="./1_files/addthis_widget.js"></script>


                <div id="resize_horizontal" class="resize_horizontal" draggable="" style="left: 1519px; top: 419px;">
                </div>

                <div id="resize_vertical" class="resize_vertical" draggable="" style="left: 853px; top: 733px;">
                </div>
